    ...
    public class MeshPiece
    {
        ...
        private void CreateMesh(){
            ...
            if (PlaneType == Plane.Front && settings.MainMaterial !=null)
            {
                ...
                meshRenderer.sharedMaterial = settings.MainMaterial;
                meshRenderer.sharedMaterial.renderQueue = RenderQueue.FrontPlane;
            ...
            if (PlaneType == Plane.Detail && settings.DetailMaterial !=null)
            {
                ...
                meshRenderer.sharedMaterial = settings.DetailMaterial;
                meshRenderer.sharedMaterial.renderQueue = RenderQueue.DetailPlane;
            }
            if (PlaneType == Plane.Top && settings.DrawTopMeshRenderer && settings.TopMaterial !=null)
            {
                ...
                meshRenderer.sharedMaterial = settings.TopMaterial;
            }
